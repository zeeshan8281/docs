---
title: 'Turn Your App into a Mini App'
...
<Warning>
  While testing your Mini App please add noIndex:true to your manifest - this is
  so the app is not indexed while in developement.
</Warning>
...
<Info>
  If your app doesn't render as an embed, double-check your manifest
  configuration and ensure all URLs are publicly accessible.
</Info>
