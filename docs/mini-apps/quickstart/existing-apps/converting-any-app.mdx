...
Mini Apps are web applications that run inside Base App and Farcaster clients instead of traditional browsers. This changes how your app is discovered, launched, and interacts with users.

### Key Differences from Regular Web Apps

**Hosted Environment**: Your app runs in an iframe or WebView within client apps like Base App
