...
# Create MiniKit App (Vite)

Create a new Mini App using Vite and MiniKit.
...
Deploy to Vercel or Netlify to get an HTTPS URL, then update `VITE_PUBLIC_URL` in your environment variables.
