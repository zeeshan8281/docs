---
title: 'Making Your App Discoverable'
...
### Manifest
Your Mini App's [metadata](/base-app/miniapps/mini-apps#metadata) is defined in your manifest file located at `/.well-known/farcaster.json`. This JSON file contains all the essential information that Base App needs to display and categorize your Mini App.
