...
4. **Agent coordinates group members** — Continues engagement, shares updates, mentions participants
...
This [API](https://docs.neynar.com/reference/lookup-developer-managed-auth-address) from Neynar will give your agent access to this data:
