...
<Warning>
This hook is now deprecated. Please follow the instructions in the [Notifications](/mini-apps/core-concepts/notifications) documentation to send notifications.
</Warning>
