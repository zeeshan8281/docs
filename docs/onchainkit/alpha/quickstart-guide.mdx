...
Building a new app? The easiest way to get started is to use `create onchain`, which sets up everything automatically for you.

After running `create onchain` and following the prompts, you'll have a [Next.js](https://nextjs.org/) project with OnchainKit installed and ready to go.
